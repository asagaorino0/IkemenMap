...
export function MapView({ initialStores, initialSelectedId }: MapViewProps) {
  ...
  return (
    <div className="relative w-full h-screen">
      <div className="absolute top-1 md:top-12 md:mt-3 left-[2%] md:left-4 z-20 max-w-md w-[82%] md:w-96">
      ...
      <div className="absolute top-1 md:top-12 md:mt-3 right-[2%] md:right-4 z-20">
        <button
